...
export class CommentsServices {
  ...
  static async addLike(commentId:string, likeStatus: typeof likeStatusEnum): Promise<ResultLikeType> {
    ...
    const newLike = {
    commentId: commentId,
    likesCount: likeStatusEnum.Like ?? 0,
    dislikesCount:  likeStatusEnum.Dislike ?? 0,
