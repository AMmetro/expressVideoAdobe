...
//         errors.errorsMessages.push({message: "Incorect Title", field: "title"})
//     } else {
//         updatedVideoItem = {...updatedVideoItem, title: title}
//     }

//     if (!author || typeof author !== "string" || !author.trim() || author.trim().length > 20) {
//         errors.errorsMessages.push({message: "Incorect author", field: "author"})
//     } else {
//         updatedVideoItem = {...updatedVideoItem, author: author}
//     }
...
//     } else {
//         updatedVideoItem = {...updatedVideoItem, canBeDownloaded: canBeDownloaded}
//     }
...
//     } else {
//         errors.errorsMessages.push({message: "Incorect age restriction access", field: "minAgeRestriction"})
//     }
...
//     } else {
//         updatedVideoItem = {...updatedVideoItem, publicationDate: publicationDate}
//     }
